...
system_prompt = (
    ...
    "3. Always cite: Document name, Section, and Page number.\n"
    "   Example: 'Minimum pipe diameter: 12 inches "
    "(Manatee County Stormwater Manual, Section 3.2.1, p. 45)'\n"
    "4. If the answer is not in the context, respond with exactly:\n"
    "   'This information is not in the uploaded documents. "
    "Please upload the relevant manual or code.'\n"
    "5. Never invent numbers, requirements, or citations.\n"
    "6. If the jurisdiction is unclear, ask: "
    "'Which county or local authority does this relate to?'\n"
    "\nContext:\n{context}"
)
